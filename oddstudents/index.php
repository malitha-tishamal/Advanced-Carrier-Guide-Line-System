...
$former_stmt->bind_param("issssii", 
...
if (empty($former_suggestions) && $current_user_course_id) {
    ...
    $former_fallback_stmt->bind_param("ii", $current_user_id, $current_user_course_id);
...
// Enhanced AI-Like Weighted Matching with Course Priority for ACTIVE STUDENTS
$active_query = "
SELECT 
    s.id, 
...
if (empty($active_suggestions) && $current_user_course_id) {
    ...
    LEFT JOIN
        hnd_courses hc ON s.course_id = hc.id
    WHERE 
        s.status = 'active' AND s.course_id = ?
    ORDER BY RAND()
    LIMIT 50
    ";
    
    $active_fallback_stmt = $conn->prepare($active_fallback_query);
    $active_fallback_stmt->bind_param("i", $current_user_course_id);
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-12 mb-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Your Profile (Former Student)</h5>
            ...
            <div class="col-lg-6">
                <div class="section-title">
                    <h4><i class="fas fa-user-graduate me-2"></i>Former Students</h4>
                    <p class="text-muted">Alumni from your course and institution</p>
                </div>
                ...
                <?php else: ?>
                    <div class="no-suggestions">
                        ...
                        <p class="text-muted">We couldn't find any matching alumni based on your course and information.</p>
                        <a href="browse-profiles.php" class="btn btn-primary">Browse All Alumni</a>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-lg-6">
                <div class="section-title">
                    <h4><i class="fas fa-user-graduate me-2"></i>Active Students</h4>
                    <p class="text-muted">Currently enrolled students from your course</p>
                </div>
                ...
                <?php else: ?>
                    <div class="no-suggestions">
                        ...
                        <p class="text-muted">We couldn't find any matching current students based on your course and information.</p>
                        <a href="browse-active-students.php" class="btn btn-primary">Browse All Students</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
